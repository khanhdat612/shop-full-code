        ...
        <div className='container_detail'>
            ...
            <div className='product'>
                <div className='product_name'>
                    <h1>IPHONE 14 PRO MAX 256GB - CHÍNH HÃNG HÀNG VN/A</h1>
                </div>
                ...
                <div className='product_pay'>
                    <div className='product_version'>
                        ...
                        <div className='product_version_GB'>
                                <span className='span1' onClick={toggleColor} className={color ? "activecolor" : null }>120GB</span>
                                <span  className='product_version_GB--span span1'>256GB</span>
                                <span className='span1'>512GB</span>
                        </div>
                    </div>
            ...
            <div className='detail_product'>
                <div className='detail_product_line'></div>
                <p className='detail_product_line--title'>SẢN PHẨM TƯƠNG TỰ</p>
                <div className='detail_product_line'></div>
            </div>
