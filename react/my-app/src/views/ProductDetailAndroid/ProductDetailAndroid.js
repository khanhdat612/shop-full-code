...
import "../ProductDetailAndroid/ProductDetailAndroid.scss";
...
import spbanchay1 from "../../images/android.png";
        ...
        <div className='container_detail'>
            ...
            <div className='navbar'>
                <ul className='navbar_ul'>
                    ...
                    <li>Android</li>
                    <li>></li>
                    <li>SamSung ultra22</li>
                </ul>
            </div>
            <div className='product'>
                <div className='product_name'>
                    <h1>Điện Thoại Android - CHÍNH HÃNG HÀNG VN/A</h1>
                </div>
                ...
                <div className='product_pay'>
                    <div className='product_version'>
                        ...
                        <div className='product_version_GB'>
                                <span className='span1' onClick={toggleColor} className={color ? "activecolor" : null }>32GB</span>
                                <span  className='product_version_GB--span span1' >128GB</span>
                                <span className='span1'>320GB</span>
                        </div>
                    </div>
...
export default ProductDetailAndroid;